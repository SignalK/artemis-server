...
public class _0183RMCExportDelta {
    ...
    public _0183RMCExportDelta withContext(String context) {
        this.context = context;
        return this;
    }

    public _0183RMCExportDelta withUpdates(List<Update> updates) {
    ...
    public _0183RMCExportDelta withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _0183RMCExportDelta) == false) {
            return false;
        }
        _0183RMCExportDelta rhs = ((_0183RMCExportDelta) other);
