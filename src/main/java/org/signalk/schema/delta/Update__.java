...
public class Update__ {
    ...
    public Update__ withSource(Source source) {
        this.source = source;
        return this;
    }

    public Update__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Update__ withValues(List<Value__> values) {
        this.values = values;
        return this;
    }
    ...
    public Update__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Update__) == false) {
            return false;
        }
        Update__ rhs = ((Update__) other);
