...
public class DocsDataModel {
    ...
    public List<Update___> updates = new ArrayList<Update___>();
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public DocsDataModel withContext(String context) {
        this.context = context;
        return this;
    }

    public DocsDataModel withUpdates(List<Update___> updates) {
