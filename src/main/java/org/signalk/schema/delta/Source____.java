...
public class Source____ {
    ...
    public Source____ withLabel(String label) {
        this.label = label;
        return this;
    }

    public Source____ withType(String type) {
        this.type = type;
        return this;
    }

    public Source____ withSrc(String src) {
        this.src = src;
        return this;
    }

    public Source____ withPgn(Integer pgn) {
        this.pgn = pgn;
        return this;
    }
    ...
    public Source____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Source____) == false) {
            return false;
        }
        Source____ rhs = ((Source____) other);
