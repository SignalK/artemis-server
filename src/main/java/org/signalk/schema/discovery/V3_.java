...
public class V3_ {
    ...
    public V3_ withVersion(String version) {
        this.version = version;
        return this;
    }

    public V3_ withSignalkHttp(String signalkHttp) {
        this.signalkHttp = signalkHttp;
        return this;
    }

    public V3_ withSignalkWs(String signalkWs) {
        this.signalkWs = signalkWs;
        return this;
    }

    public V3_ withSignalkTcp(String signalkTcp) {
    ...
    public V3_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
