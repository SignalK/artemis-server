...
public class LineLineVoltage_ {
    ...
    public LineLineVoltage_ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineLineVoltage_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineLineVoltage_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineLineVoltage_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineLineVoltage_) == false) {
            return false;
        }
        LineLineVoltage_ rhs = ((LineLineVoltage_) other);
