...
public class LineLineVoltage____ {
    ...
    public LineLineVoltage____ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineLineVoltage____ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineLineVoltage____ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineLineVoltage____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineLineVoltage____) == false) {
            return false;
        }
        LineLineVoltage____ rhs = ((LineLineVoltage____) other);
