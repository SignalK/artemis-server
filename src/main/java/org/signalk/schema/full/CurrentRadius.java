...
public class CurrentRadius {

    @JsonProperty("value")
    public Value______ value;
    ...
    public CurrentRadius withValue(Value______ value) {
        this.value = value;
        return this;
    }

    public CurrentRadius withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public CurrentRadius with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public CurrentRadius withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurrentRadius) == false) {
            return false;
        }
        CurrentRadius rhs = ((CurrentRadius) other);
