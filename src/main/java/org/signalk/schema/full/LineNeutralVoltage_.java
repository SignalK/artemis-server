...
public class LineNeutralVoltage_ {
    ...
    public LineNeutralVoltage_ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineNeutralVoltage_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineNeutralVoltage_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineNeutralVoltage_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineNeutralVoltage_) == false) {
            return false;
        }
        LineNeutralVoltage_ rhs = ((LineNeutralVoltage_) other);
