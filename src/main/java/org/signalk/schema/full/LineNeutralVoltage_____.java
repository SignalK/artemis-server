...
public class LineNeutralVoltage_____ {
    ...
    public LineNeutralVoltage_____ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineNeutralVoltage_____ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineNeutralVoltage_____ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineNeutralVoltage_____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineNeutralVoltage_____) == false) {
            return false;
        }
        LineNeutralVoltage_____ rhs = ((LineNeutralVoltage_____) other);
