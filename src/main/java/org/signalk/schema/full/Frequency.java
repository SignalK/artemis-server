...
public class Frequency {
    ...
    public Frequency withValue(Integer value) {
        this.value = value;
        return this;
    }

    public Frequency withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Frequency with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Frequency withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
