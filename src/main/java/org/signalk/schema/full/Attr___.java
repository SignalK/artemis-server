...
public class Attr___ {
    ...
    public Attr___ withMode(Integer mode) {
        this.mode = mode;
        return this;
    }

    public Attr___ withOwner(String owner) {
        this.owner = owner;
        return this;
    }

    public Attr___ withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public Attr___ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Attr___) == false) {
            return false;
        }
        Attr___ rhs = ((Attr___) other);
