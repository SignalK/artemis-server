...
public class Vessels__ {

    @JsonProperty("urn:mrn:imo:mmsi:366982330")
    public UrnMrnImoMmsi366982330__ urnMrnImoMmsi366982330;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public Vessels__ withUrnMrnImoMmsi366982330(UrnMrnImoMmsi366982330__ urnMrnImoMmsi366982330) {
    ...
    public Vessels__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vessels__) == false) {
            return false;
        }
        Vessels__ rhs = ((Vessels__) other);
