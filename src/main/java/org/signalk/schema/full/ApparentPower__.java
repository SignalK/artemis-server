...
public class ApparentPower__ {
    ...
    public ApparentPower__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public ApparentPower__ with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public ApparentPower__ withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public ApparentPower__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApparentPower__) == false) {
            return false;
        }
        ApparentPower__ rhs = ((ApparentPower__) other);
