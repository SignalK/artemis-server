...
public class ApparentPower {
    ...
    public ApparentPower withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public ApparentPower with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public ApparentPower withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public ApparentPower withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApparentPower) == false) {
            return false;
        }
        ApparentPower rhs = ((ApparentPower) other);
