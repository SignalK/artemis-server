...
public class Frequency_ {
    ...
    public Frequency_ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public Frequency_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Frequency_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Frequency_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Frequency_) == false) {
            return false;
        }
        Frequency_ rhs = ((Frequency_) other);
