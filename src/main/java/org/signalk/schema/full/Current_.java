...
public class Current_ {
    ...
    public Current_ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public Current_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Current_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Current_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
