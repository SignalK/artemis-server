...
public class LineLineVoltage___ {
    ...
    public LineLineVoltage___ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineLineVoltage___ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineLineVoltage___ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineLineVoltage___ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineLineVoltage___) == false) {
            return false;
        }
        LineLineVoltage___ rhs = ((LineLineVoltage___) other);
