...
public class Vessels______ {

    @JsonProperty("urn:mrn:signalk:uuid:c0d79334-4e25-4245-8892-54e8ccc8021d")
    public UrnMrnSignalkUuidC0d793344e254245889254e8ccc8021d__ urnMrnSignalkUuidC0d793344e254245889254e8ccc8021d;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public Vessels______ withUrnMrnSignalkUuidC0d793344e254245889254e8ccc8021d(UrnMrnSignalkUuidC0d793344e254245889254e8ccc8021d__ urnMrnSignalkUuidC0d793344e254245889254e8ccc8021d) {
    ...
    public Vessels______ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vessels______) == false) {
            return false;
        }
        Vessels______ rhs = ((Vessels______) other);
