...
public class Current__ {
    ...
    public Current__ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public Current__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Current__ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Current__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Current__) == false) {
            return false;
        }
        Current__ rhs = ((Current__) other);
