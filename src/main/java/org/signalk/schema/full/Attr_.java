...
public class Attr_ {
    ...
    public Attr_ withMode(Integer mode) {
        this.mode = mode;
        return this;
    }

    public Attr_ withOwner(String owner) {
        this.owner = owner;
        return this;
    }

    public Attr_ withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public Attr_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Attr_) == false) {
            return false;
        }
        Attr_ rhs = ((Attr_) other);
