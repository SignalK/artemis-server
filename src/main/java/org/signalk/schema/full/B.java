...
public class B {
    ...
    public LineLineVoltage_ lineLineVoltage;
    @JsonProperty("lineNeutralVoltage")
    public LineNeutralVoltage_ lineNeutralVoltage;
    @JsonProperty("frequency")
    public Frequency_ frequency;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public B withLineLineVoltage(LineLineVoltage_ lineLineVoltage) {
        this.lineLineVoltage = lineLineVoltage;
        return this;
    }

    public B withLineNeutralVoltage(LineNeutralVoltage_ lineNeutralVoltage) {
        this.lineNeutralVoltage = lineNeutralVoltage;
        return this;
    }

    public B withFrequency(Frequency_ frequency) {
    ...
    public B withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
