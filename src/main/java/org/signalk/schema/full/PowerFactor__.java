...
public class PowerFactor__ {
    ...
    public PowerFactor__ withValue(Double value) {
        this.value = value;
        return this;
    }

    public PowerFactor__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public PowerFactor__ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public PowerFactor__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PowerFactor__) == false) {
            return false;
        }
        PowerFactor__ rhs = ((PowerFactor__) other);
