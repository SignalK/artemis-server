...
public class PowerFactor {
    ...
    public PowerFactor withValue(Double value) {
        this.value = value;
        return this;
    }

    public PowerFactor withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public PowerFactor with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public PowerFactor withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PowerFactor) == false) {
            return false;
        }
        PowerFactor rhs = ((PowerFactor) other);
