...
public class _0183RMCExport {

    @JsonProperty("self")
    public String self;
    @JsonProperty("vessels")
    public Vessels_ vessels;
    @JsonProperty("version")
    public String version;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public _0183RMCExport withSelf(String self) {
        this.self = self;
        return this;
    }

    public _0183RMCExport withVessels(Vessels_ vessels) {
        this.vessels = vessels;
        return this;
    }

    public _0183RMCExport withVersion(String version) {
    ...
    public _0183RMCExport withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _0183RMCExport) == false) {
            return false;
        }
        _0183RMCExport rhs = ((_0183RMCExport) other);
