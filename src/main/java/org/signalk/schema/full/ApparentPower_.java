...
public class ApparentPower_ {
    ...
    public ApparentPower_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public ApparentPower_ with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public ApparentPower_ withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public ApparentPower_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApparentPower_) == false) {
            return false;
        }
        ApparentPower_ rhs = ((ApparentPower_) other);
