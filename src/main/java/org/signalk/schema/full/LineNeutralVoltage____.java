...
public class LineNeutralVoltage____ {
    ...
    public LineNeutralVoltage____ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineNeutralVoltage____ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineNeutralVoltage____ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineNeutralVoltage____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineNeutralVoltage____) == false) {
            return false;
        }
        LineNeutralVoltage____ rhs = ((LineNeutralVoltage____) other);
