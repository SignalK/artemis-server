...
public class Frequency__ {
    ...
    public Frequency__ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public Frequency__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Frequency__ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Frequency__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Frequency__) == false) {
            return false;
        }
        Frequency__ rhs = ((Frequency__) other);
