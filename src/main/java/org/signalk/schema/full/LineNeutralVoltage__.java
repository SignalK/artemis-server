...
public class LineNeutralVoltage__ {
    ...
    public LineNeutralVoltage__ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineNeutralVoltage__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineNeutralVoltage__ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineNeutralVoltage__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineNeutralVoltage__) == false) {
            return false;
        }
        LineNeutralVoltage__ rhs = ((LineNeutralVoltage__) other);
