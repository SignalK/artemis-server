...
public class Mob_ {
    ...
    public Mob_ withValue(Value_______ value) {
        this.value = value;
        return this;
    }

    public Mob_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Mob_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Mob_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Mob_) == false) {
            return false;
        }
        Mob_ rhs = ((Mob_) other);
