...
public class LineNeutralVoltage___ {
    ...
    public LineNeutralVoltage___ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineNeutralVoltage___ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineNeutralVoltage___ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineNeutralVoltage___ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineNeutralVoltage___) == false) {
            return false;
        }
        LineNeutralVoltage___ rhs = ((LineNeutralVoltage___) other);
