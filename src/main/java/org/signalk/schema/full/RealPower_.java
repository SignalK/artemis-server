...
public class RealPower_ {
    ...
    public RealPower_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public RealPower_ with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public RealPower_ withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public RealPower_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RealPower_) == false) {
            return false;
        }
        RealPower_ rhs = ((RealPower_) other);
