...
public class LineLineVoltage_____ {
    ...
    public LineLineVoltage_____ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineLineVoltage_____ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineLineVoltage_____ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineLineVoltage_____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineLineVoltage_____) == false) {
            return false;
        }
        LineLineVoltage_____ rhs = ((LineLineVoltage_____) other);
