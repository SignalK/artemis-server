...
public class ReactivePower {
    ...
    public ReactivePower withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public ReactivePower with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public ReactivePower withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public ReactivePower withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReactivePower) == false) {
            return false;
        }
        ReactivePower rhs = ((ReactivePower) other);
