...
public class RealPower__ {
    ...
    public RealPower__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public RealPower__ with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public RealPower__ withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public RealPower__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RealPower__) == false) {
            return false;
        }
        RealPower__ rhs = ((RealPower__) other);
