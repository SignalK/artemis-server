...
public class PowerFactor_ {
    ...
    public PowerFactor_ withValue(Double value) {
        this.value = value;
        return this;
    }

    public PowerFactor_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public PowerFactor_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public PowerFactor_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PowerFactor_) == false) {
            return false;
        }
        PowerFactor_ rhs = ((PowerFactor_) other);
