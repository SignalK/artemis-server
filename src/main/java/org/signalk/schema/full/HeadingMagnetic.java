...
public class HeadingMagnetic {
    ...
    public HeadingMagnetic withValue(Double value) {
        this.value = value;
        return this;
    }

    public HeadingMagnetic with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public HeadingMagnetic withSentence(String sentence) {
        this.sentence = sentence;
        return this;
    }

    public HeadingMagnetic withTimestamp(String timestamp) {
    ...
    public HeadingMagnetic withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HeadingMagnetic) == false) {
            return false;
        }
        HeadingMagnetic rhs = ((HeadingMagnetic) other);
