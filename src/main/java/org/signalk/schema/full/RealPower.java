...
public class RealPower {
    ...
    public RealPower withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public RealPower with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public RealPower withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public RealPower withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RealPower) == false) {
            return false;
        }
        RealPower rhs = ((RealPower) other);
