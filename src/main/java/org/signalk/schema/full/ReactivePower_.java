...
public class ReactivePower_ {
    ...
    public ReactivePower_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public ReactivePower_ with$source(String $source) {
        this.$source = $source;
        return this;
    }

    public ReactivePower_ withValue(Integer value) {
        this.value = value;
        return this;
    }
    ...
    public ReactivePower_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReactivePower_) == false) {
            return false;
        }
        ReactivePower_ rhs = ((ReactivePower_) other);
