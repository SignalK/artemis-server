...
public class Vessels____ {

    @JsonProperty("urn:mrn:signalk:uuid:c0d79334-4e25-4245-8892-54e8ccc8021d")
    public UrnMrnSignalkUuidC0d793344e254245889254e8ccc8021d urnMrnSignalkUuidC0d793344e254245889254e8ccc8021d;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public Vessels____ withUrnMrnSignalkUuidC0d793344e254245889254e8ccc8021d(UrnMrnSignalkUuidC0d793344e254245889254e8ccc8021d urnMrnSignalkUuidC0d793344e254245889254e8ccc8021d) {
    ...
    public Vessels____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vessels____) == false) {
            return false;
        }
        Vessels____ rhs = ((Vessels____) other);
