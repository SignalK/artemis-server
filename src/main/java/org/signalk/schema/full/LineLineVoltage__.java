...
public class LineLineVoltage__ {
    ...
    public LineLineVoltage__ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineLineVoltage__ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineLineVoltage__ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineLineVoltage__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineLineVoltage__) == false) {
            return false;
        }
        LineLineVoltage__ rhs = ((LineLineVoltage__) other);
