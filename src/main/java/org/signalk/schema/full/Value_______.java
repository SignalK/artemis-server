...
public class Value_______ {
    ...
    public Value_______ withMessage(String message) {
        this.message = message;
        return this;
    }

    public Value_______ withState(String state) {
        this.state = state;
        return this;
    }

    public Value_______ withMethod(List<String> method) {
        this.method = method;
        return this;
    }
    ...
    public Value_______ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Value_______) == false) {
            return false;
        }
        Value_______ rhs = ((Value_______) other);
