...
public class Frequency____ {
    ...
    public Frequency____ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public Frequency____ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Frequency____ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Frequency____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Frequency____) == false) {
            return false;
        }
        Frequency____ rhs = ((Frequency____) other);
