...
public class LineLineVoltage {
    ...
    public LineLineVoltage withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineLineVoltage withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineLineVoltage with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineLineVoltage withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineLineVoltage) == false) {
            return false;
        }
        LineLineVoltage rhs = ((LineLineVoltage) other);
