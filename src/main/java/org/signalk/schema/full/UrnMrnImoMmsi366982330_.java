...
public class UrnMrnImoMmsi366982330_ {

    @JsonProperty("mmsi")
    public String mmsi;
    @JsonProperty("navigation")
    public Navigation_ navigation;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public UrnMrnImoMmsi366982330_ withMmsi(String mmsi) {
        this.mmsi = mmsi;
        return this;
    }

    public UrnMrnImoMmsi366982330_ withNavigation(Navigation_ navigation) {
    ...
    public UrnMrnImoMmsi366982330_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UrnMrnImoMmsi366982330_) == false) {
            return false;
        }
        UrnMrnImoMmsi366982330_ rhs = ((UrnMrnImoMmsi366982330_) other);
