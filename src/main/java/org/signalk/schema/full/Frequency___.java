...
public class Frequency___ {
    ...
    public Frequency___ withValue(Integer value) {
        this.value = value;
        return this;
    }

    public Frequency___ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public Frequency___ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public Frequency___ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Frequency___) == false) {
            return false;
        }
        Frequency___ rhs = ((Frequency___) other);
