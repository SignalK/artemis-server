...
public class Attr {
    ...
    public Attr withMode(Integer mode) {
        this.mode = mode;
        return this;
    }

    public Attr withOwner(String owner) {
        this.owner = owner;
        return this;
    }

    public Attr withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public Attr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
