...
public class LineNeutralVoltage {
    ...
    public LineNeutralVoltage withValue(Integer value) {
        this.value = value;
        return this;
    }

    public LineNeutralVoltage withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public LineNeutralVoltage with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public LineNeutralVoltage withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LineNeutralVoltage) == false) {
            return false;
        }
        LineNeutralVoltage rhs = ((LineNeutralVoltage) other);
