...
public class Value______ {
    ...
    public Value______ withMethod(List<String> method) {
        this.method = method;
        return this;
    }

    public Value______ withState(String state) {
        this.state = state;
        return this;
    }

    public Value______ withMessage(String message) {
    ...
    public Value______ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Value______) == false) {
            return false;
        }
        Value______ rhs = ((Value______) other);
