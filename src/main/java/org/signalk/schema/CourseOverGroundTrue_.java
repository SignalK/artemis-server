...
public class CourseOverGroundTrue_ {
    ...
    public CourseOverGroundTrue_ withValue(Double value) {
        this.value = value;
        return this;
    }

    public CourseOverGroundTrue_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public CourseOverGroundTrue_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public CourseOverGroundTrue_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseOverGroundTrue_) == false) {
            return false;
        }
        CourseOverGroundTrue_ rhs = ((CourseOverGroundTrue_) other);
