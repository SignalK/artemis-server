...
public class SpeedOverGround_ {
    ...
    public SpeedOverGround_ withValue(Double value) {
        this.value = value;
        return this;
    }

    public SpeedOverGround_ withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public SpeedOverGround_ with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public SpeedOverGround_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpeedOverGround_) == false) {
            return false;
        }
        SpeedOverGround_ rhs = ((SpeedOverGround_) other);
