...
public class Subscribe_____ {
    ...
    public Subscribe_____ withPath(String path) {
        this.path = path;
        return this;
    }

    public Subscribe_____ withPeriod(Integer period) {
        this.period = period;
        return this;
    }

    public Subscribe_____ withFormat(String format) {
        this.format = format;
        return this;
    }

    public Subscribe_____ withPolicy(String policy) {
        this.policy = policy;
        return this;
    }

    public Subscribe_____ withMinPeriod(Integer minPeriod) {
    ...
    public Subscribe_____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Subscribe_____) == false) {
            return false;
        }
        Subscribe_____ rhs = ((Subscribe_____) other);
