...
public class Subscribe____ {
    ...
    public Subscribe____ withPath(String path) {
        this.path = path;
        return this;
    }

    public Subscribe____ withPeriod(Integer period) {
        this.period = period;
        return this;
    }

    public Subscribe____ withFormat(String format) {
        this.format = format;
        return this;
    }

    public Subscribe____ withPolicy(String policy) {
        this.policy = policy;
        return this;
    }

    public Subscribe____ withMinPeriod(Integer minPeriod) {
    ...
    public Subscribe____ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Subscribe____) == false) {
            return false;
        }
        Subscribe____ rhs = ((Subscribe____) other);
