...
public class Subscribe {
    ...
    public Subscribe withPath(String path) {
        this.path = path;
        return this;
    }

    public Subscribe withPeriod(Integer period) {
        this.period = period;
        return this;
    }

    public Subscribe withFormat(String format) {
        this.format = format;
        return this;
    }

    public Subscribe withPolicy(String policy) {
        this.policy = policy;
        return this;
    }

    public Subscribe withMinPeriod(Integer minPeriod) {
