...
public class DocsSubscriptionProtocol1 {

    @JsonProperty("context")
    public String context;
    @JsonProperty("subscribe")
    public List<Subscribe> subscribe = new ArrayList<Subscribe>();
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public DocsSubscriptionProtocol1 withContext(String context) {
        this.context = context;
        return this;
    }

    public DocsSubscriptionProtocol1 withSubscribe(List<Subscribe> subscribe) {
    ...
    public DocsSubscriptionProtocol1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DocsSubscriptionProtocol1) == false) {
            return false;
        }
        DocsSubscriptionProtocol1 rhs = ((DocsSubscriptionProtocol1) other);
