...
public class SignalkSubscribe {

    @JsonProperty("context")
    public String context;
    @JsonProperty("subscribe")
    public List<Subscribe_____> subscribe = new ArrayList<Subscribe_____>();
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public SignalkSubscribe withContext(String context) {
        this.context = context;
        return this;
    }

    public SignalkSubscribe withSubscribe(List<Subscribe_____> subscribe) {
    ...
    public SignalkSubscribe withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SignalkSubscribe) == false) {
            return false;
        }
        SignalkSubscribe rhs = ((SignalkSubscribe) other);
