...
public class Unsubscribe__ {
    ...
    public Unsubscribe__ withPath(String path) {
        this.path = path;
        return this;
    }

    public Unsubscribe__ withPeriod(Integer period) {
        this.period = period;
        return this;
    }

    public Unsubscribe__ withFormat(String format) {
        this.format = format;
        return this;
    }

    public Unsubscribe__ withPolicy(String policy) {
        this.policy = policy;
        return this;
    }

    public Unsubscribe__ withMinPeriod(Integer minPeriod) {
    ...
    public Unsubscribe__ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Unsubscribe__) == false) {
            return false;
        }
        Unsubscribe__ rhs = ((Unsubscribe__) other);
