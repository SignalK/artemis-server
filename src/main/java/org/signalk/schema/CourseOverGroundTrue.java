...
public class CourseOverGroundTrue {
    ...
    public CourseOverGroundTrue withValue(Double value) {
        this.value = value;
        return this;
    }

    public CourseOverGroundTrue withTimestamp(String timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public CourseOverGroundTrue with$source(String $source) {
        this.$source = $source;
        return this;
    }
    ...
    public CourseOverGroundTrue withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseOverGroundTrue) == false) {
            return false;
        }
        CourseOverGroundTrue rhs = ((CourseOverGroundTrue) other);
